...
void setup(void) {
  ...
  const char* ssid = "Clock Gallery Access";
  const char* password = "moomin123";

  WiFi.softAP(ssid, password);  //Network and password for the access point generated by ESP32
